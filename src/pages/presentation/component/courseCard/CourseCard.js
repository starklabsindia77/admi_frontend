...
function CourseCard({ data, wishData }) {
	...
	return (
		<div className='post'>
			<Stack direction='row' justifyContent="space-between" p={2}>
				<Typography variant="h6" p={2} style={{width:"180px",height:"150px"}} mt={4}>{data.name}</Typography>
  ...
  <TextSnippetIcon fontSize='large'/>
							...
							<Button  style={{ width: "150px", height: "50px", mt: '30px',}} variant="contained" color="info">Apply Now</Button>
						</Stack>
					</Stack>
					<Stack direction='row' justifyContent='space-around' p={2} style={{ backgroundColor: "#F1F2F5", borderRadius: "10px" }}>
						<Stack style={{ bgColor: "D6D6D6" }}>
							<Typography ml={2} color="#6b7280">TUITION FEE </Typography>
							<Typography variant='h6' fontWeight="600">≈ $ 15000 AUD</Typography>
						</Stack>
						<Stack>
							<Typography ml={2} color="#6b7280">TUITION FEE </Typography>
							<Typography variant='h6' fontWeight="600">≈ $ 15000 AUD</Typography>
